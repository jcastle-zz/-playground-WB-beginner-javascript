...
class TSModuleGraph {
  ...
  getExport(m, e) {
    ...
    if (e.specifier && e.imported) {
      let {
        module,
        name
      } = (0, _nullthrows.default)(this.resolveExport((0, _nullthrows.default)(this.getModule(e.specifier)), e.imported));
      return {
        module,
        imported: name,
        name: exportName
    ...
    if (m.imports.has(exportName)) {
      let {
        module,
        name
      } = (0, _nullthrows.default)(this.resolveImport(m, exportName));
      return {
        module,
        imported: name,
        name: exportName
  ...
  resolveImport(module, local, imported) {
    ...
    let m = (0, _nullthrows.default)(this.getModule(i.specifier));
  ...
  getAllExports(module = (0, _nullthrows.default)(this.mainModule), excludeDefault = false) {
    ...
    for (let e of module.exports) {
      if (e.name && (!excludeDefault || e.name !== 'default')) {
        ...
        res.push(...this.getAllExports((0, _nullthrows.default)(this.getModule(e.specifier)), true));
      }
    }
