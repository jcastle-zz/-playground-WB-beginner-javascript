...
const SIZE = 10; // Make a new face detector
...
function censor({
  ...
  face.y, SIZE, SIZE); // take the face back out and draw it back to normal size
...
//# sourceMappingURL=pixelated-face-playground.d358bc83.js.map
