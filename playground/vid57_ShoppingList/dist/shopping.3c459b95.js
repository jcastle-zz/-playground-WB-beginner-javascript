...
var list = document.querySelector('.list'); // We need an array to hold our state. State means a bunch of data that reflects the state of your application. Here it is a list of items, how many of each item, how expensive, coupons, etc. You should always be able to recreate application given the data. It should be reflected in object or array.
...
function handleSubmit(e) {
  ...
  e.target.reset(); // Fire off custom event to tell anyone else who cares that the items have been updated.
...
},{}]},{},["../../../../../.nvm/versions/node/v10.17.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shopping.js"], null)
