...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"gallery-prototype.js":[function(require,module,exports) {
function Gallery(gallery) {
  ...
  this.nextButton = this.modal.querySelector('.next'); // bind our methods to the instance when we need them

  this.showNextImage = this.showNextImage.bind(this);
  this.showPrevImage = this.showPrevImage.bind(this);
  this.handleKeyUp = this.handleKeyUp.bind(this);
  this.handleClickOutside = this.handleClickOutside.bind(this); // These are our Event Listeners!
...
Gallery.prototype.openModal = function () {
  ...
  this.modal.classList.add('open'); // Event listeners to be bound when we open the modal:
...
Gallery.prototype.closeModal = function () {
  this.modal.classList.remove('open'); // TODO: add event listeners for clicks and keyboard..
...
},{}]},{},["../../../../../.nvm/versions/node/v10.17.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","gallery-prototype.js"], null)
//# sourceMappingURL=/gallery-prototype.afd69eb4.js.map