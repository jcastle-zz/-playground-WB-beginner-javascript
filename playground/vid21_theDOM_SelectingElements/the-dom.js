...
const divs = document.querySelectorAll('div'); // creates a node list, not an array but similar to one
console.log(p);
console.log(divs);
...
// can also get element by ID = document.getElementByID('p'), document.getElementByClassName() - but should be able to use querySelecter() and querySelecterAll()
