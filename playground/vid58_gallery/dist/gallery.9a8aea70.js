...
function Gallery(gallery) {
  ...
  function openModal() {
    console.info('Opening modal...'); // First check if the modal is open

    if (modal.matches('.open')) {
      console.info('Modal already open');
    }

    modal.classList.add('open'); // Event listeners bound when we open the modal
...
},{}]},{},["../../../../../.nvm/versions/node/v10.17.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","gallery.js"], null)
